...
char char_array[n+1];
int a;
string ax ="the 23.3  number 444";
//getNumberFromString (buffer);
...
if (n>20){
for (a=35; a<38; a++){
char_array[a-35]=buffer[a];}
printf("The output: %s",char_array);}
putchar('\n');
printf("%f",float_array[2]);
if (float_array[1]>10){
digitalWrite(GPIO_ROLL, HIGH);}
else {digitalWrite(GPIO_ROLL, LOW);}
//if(float_array[2]>10){
//digitalWrite(GPIO_PITCH, HIGH);}
//else {digitalWrite(GPIO_PITCH, LOW);}
